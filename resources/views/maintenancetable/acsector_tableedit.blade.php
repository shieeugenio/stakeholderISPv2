					...
					<div class = "tablecon">
						<table id="datatable" class="ui celled table" cellspacing="0" width="100%">
							...
							<input type="hidden" name="acsectorID" value="{{$sec->ID}}">
						    	<tr>
						       		<td name="acsectorID" type="number" readonly="true" value="{{$sec->ID}}" onclick="Row_Click(this.id);">
						       			<center>{{$sec->ID}}</center>
						       		</td>
						    		<td name="acsectorName" type="text" value="{{$sec->sectorname}}" onclick="Row_Click(this.id);">
