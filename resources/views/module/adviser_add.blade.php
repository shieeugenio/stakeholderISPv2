...
@section('maincontent')
	...
	<script type="text/javascript">
		...
		function addProfile()
		{
			var title = document.getElementsByName('traintitle[]');
			var traincat = document.getElementsByName('traincateg[]');
			var othercat = document.getElementsByName('othercat[]');
			var loc = document.getElementsByName('location[]');
			var trainingdate = document.getElementsByName('traindate[]');
			var trainingtime = document.getElementsByName('traintime[]');
			var org = document.getElementsByName('trainorg[]');
			var speaker = document.getElementsByName('inputlecturer[][]');
			...
			var trainorg = new array();
			var lecturer = new array(array());

			for(var l=0;l<sizeof(traincat);l++)
			{
				if(traincat[l]==7){
					traincat[l] = othercat[l];
				}
			}

			for(var ctr=0;ctr<title.length;ctr++)
			{
				 traintitle.push(title[ctr].value);
				 traincateg.push(traincat[ctr].value);
				 location.push(traindate[ctr].value);
				 traindate.push(trainingdate[ctr].value);
				 traintime.push(trainingtime[ctr].value);
				 trainorg.push(org[ctr].value);
				 for(var i=0;ctr<lecturers.length;i++){
				 	lecturer.push(lecturers[ctr][i]);
				 }
			}
			...
			var data = {
				...
				'gender' : document.getElementsByName('street')[0].value,
				'street' : document.getElementsByName('street')[0].checked.value,
				...
				'categ' : document.getElementsByName('accateg')[0].checked.value,
				//advisory Council
				'startdate' : document.getElementsByName('durationsdate')[0].value,
				'enddate' : document.getElementsByName('durationedate')[0].value,
